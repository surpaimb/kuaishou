...
namespace Surpaimb\KuaiShou\Kernel\Traits;

use Surpaimb\KuaiShou\Kernel\Clauses\Clause;
use Surpaimb\KuaiShou\Kernel\Contracts\EventHandlerInterface;
use Surpaimb\KuaiShou\Kernel\Decorators\FinallyResult;
use Surpaimb\KuaiShou\Kernel\Decorators\TerminateResult;
...
trait Observable
{
     ...
     *
     * @return \Surpaimb\KuaiShou\Kernel\Clauses\Clause
     *
