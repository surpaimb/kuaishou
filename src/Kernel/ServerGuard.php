...
use Surpaimb\KuaiShou\Kernel\Contracts\MessageInterface;
use Surpaimb\KuaiShou\Kernel\Exceptions\BadRequestException;
use Surpaimb\KuaiShou\Kernel\Exceptions\InvalidArgumentException;
use Surpaimb\KuaiShou\Kernel\Messages\Message;
use Surpaimb\KuaiShou\Kernel\Messages\News;
use Surpaimb\KuaiShou\Kernel\Messages\NewsItem;
use Surpaimb\KuaiShou\Kernel\Messages\Raw as RawMessage;
use Surpaimb\KuaiShou\Kernel\Messages\Text;
use Surpaimb\KuaiShou\Kernel\Support\XML;
use Surpaimb\KuaiShou\Kernel\Traits\Observable;
use Surpaimb\KuaiShou\Kernel\Traits\ResponseCastable;
...
class ServerGuard
{
     ...
     * @return $this
     *
     * @throws \Surpaimb\KuaiShou\Kernel\Exceptions\BadRequestException
     */
     ...
     * Get request message.
     *
     * @return array|\Surpaimb\KuaiShou\Kernel\Support\Collection|object|string
     *
     * @throws BadRequestException
     * @throws \Surpaimb\KuaiShou\Kernel\Exceptions\InvalidArgumentException
     * @throws \Surpaimb\KuaiShou\Kernel\Exceptions\InvalidConfigException
     ...
     * @param string                                                   $to
     * @param string                                                   $from
     * @param \Surpaimb\KuaiShou\Kernel\Contracts\MessageInterface|string|int $message
     *
     * @return string
     *
     * @throws \Surpaimb\KuaiShou\Kernel\Exceptions\InvalidArgumentException
     ...
     * @param string                                        $to
     * @param string                                        $from
     * @param \Surpaimb\KuaiShou\Kernel\Contracts\MessageInterface $message
     *
     * @return string
     */
