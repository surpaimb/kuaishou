...
namespace Surpaimb\KuaiShou\Kernel\Log;
...
class LogManager implements LoggerInterface
{
    ...
    {
        return new Monolog('Surpaimb\KuaiShou', $this->prepareHandlers([new StreamHandler(
    ...
    protected function createSlackDriver(array $config)
    {
        return new Monolog($this->parseChannel($config), [
            $this->prepareHandler(new SlackWebhookHandler(
                $config['url'],
                $config['channel'] ?? null,
                $config['username'] ?? 'Surpaimb\KuaiShou',
    ...
    {
        return $config['name'] ?? 'Surpaimb\KuaiShou';
    }
